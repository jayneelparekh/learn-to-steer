...
for subset in adversarial popular random; do
    ...
    for steering_alpha in 1; do
        ...
        for i in 14; do
            shift_vector_path=${save_dir}/shift_vectors/${model}_${i}_${shift_type}_${subset}_${dataset_name}_${dataset_size}_random.pth
            save_filename="${model}_${dataset_name}_steer_${i}_yes_no_${subset}_${steering_alpha}_random"
...
for subset in adversarial popular random; do
    ...
    for steering_alpha in 1; do
        ...
        for i in 17; do
            shift_vector_path=/data/khayatan/Hallucination/POPE/hallucination/shift_vectors/${model}_${i}_average_${subset}_${dataset_name}_${dataset_size}_random.pth
            save_filename="${model}_${dataset_name}_steer_${i}_yes_no_${subset}_${steering_alpha}_random"
